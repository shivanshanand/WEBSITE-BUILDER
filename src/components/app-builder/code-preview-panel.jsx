...
export function CodePreviewPanel({ files, activeFile, onFileSelect, onFileChange }) {
    ...
    return (
      <div className="flex flex-col h-full bg-neutral-950">
        <div className="p-4 border-b border-neutral-800">
          <h2 className="text-lg font-semibold text-neutral-100">Code & Preview</h2>
        </div>
        <div className="flex-1 flex items-center justify-center text-neutral-500">
          <div className="text-center">
            <Code size={48} className="mx-auto mb-4 opacity-50" />
            <p className="mb-2">Generate an app to see the code and preview</p>
            <p className="text-sm text-neutral-600">Use the chat to describe your app</p>
          </div>
        </div>
      </div>
    );
